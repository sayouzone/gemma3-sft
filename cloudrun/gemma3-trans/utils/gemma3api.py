...
class Gemma3API:
    ...
    def generate_en_ko_translation(self, sentence):
        translation_prompt = self.prompt_en_ko_translation(sentence)
        messages = translation_prompt.get("messages")
        user_prompt = translation_prompt.get("user_prompt")
        print('user_prompt', user_prompt, type(user_prompt))
    ...
    def prompt_sql(self, data):
        ...
        messages = prompts.prompts.get("sql")
        system_message = messages.get("system_message")
        user_prompt = messages.get("user_prompt")
    ...
    def prompt_product(self, product):
        messages = prompts.prompts.get("product")
        system_message = messages.get("system_message")
        user_prompt = messages.get("user_prompt")
    ...
    # Convert dataset to OAI messages
    def prompt_en_ko_translation(self, sentence):
        messages = prompts.prompts.get("en-ko-trans")
        system_message = messages.get("system_message")
        user_prompt = messages.get("user_prompt")
